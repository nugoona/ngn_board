"""
2024년 12월 1일 ~ 2025년 11월 30일 데이터 재수집 스크립트
- daily_cafe24_sales 테이블 데이터 삭제 후 재수집
- 총 365일 (약 12개월) 데이터 처리
"""
import os
...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler("recover_2024_12_2025_11_data.log", encoding="utf-8"),
...
def main():
    logging.info("=" * 80)
    logging.info("🔧 2024년 12월 1일 ~ 2025년 11월 30일 데이터 재수집 시작")
    logging.info("=" * 80)
