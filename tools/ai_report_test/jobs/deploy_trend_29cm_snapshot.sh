...
# 29CM 트렌드 스냅샷 생성 Cloud Run Job 배포 스크립트
...
# 한국시간 매주 월요일 오전 7시 5분 = cron "5 7 * * 1"
SCHEDULER_NAME="trend-29cm-snapshot-scheduler"
...
echo "  - Cloud Scheduler: ${SCHEDULER_NAME} (매주 월요일 오전 7시 5분 한국시간 실행)"
echo ""
echo "📝 수동 실행:"
