"""
2026-01-02 날짜만 daily_cafe24_sales 재수집 스크립트
"""
import os
...
def main():
    logging.info("=" * 60)
    logging.info("🔧 2026-01-02 daily_cafe24_sales 재수집 시작")
    logging.info("=" * 60)
    
    # 2026-01-02만 처리
    run_daily_sales_query('2026-01-02')
    
    logging.info("=" * 60)
    logging.info("✅ 2026-01-02 daily_cafe24_sales 재수집 완료!")
    logging.info("=" * 60)
